...
- sync behavior in `docs/sync-settings.md`
- topic selection behavior in `docs/topic selection rules.md`
- meanings of words in `docs/glossary.md`
- local versus global data in `docs/data-ownership.md`
- short change notes in `docs/change-log.md`

## Merge Later If Needed

- `docs/data-ownership.md` into `docs/sync-settings.md`
- `docs/change-log.md` into `docs/index.md`
